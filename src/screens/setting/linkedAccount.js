...
import {Heading, Section, SubSection} from '@text';
import {themeDefault} from '@themes';
import {getStorage} from '@storage';

const LinkedAccounts = ({navigation}) => {
  const twitterHandleFromStore = getStorage('twitter');
  const websiteFromStore = getStorage('web');
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <Heading
          title={"something you don't see here"}
